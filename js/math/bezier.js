...
export const cubicDerivative = (x1, x2, x3, x4, t) => {
    const ti = 1 - t;
    return (3 * ti * ti * (x2 - x1) + 6 * ti * t * (x3 - x2) + 3 * t * t * (x4 - x3));
};
/**
...
export const cubicDerivativeSecond = (x1, x2, x3, x4, t) => {
    return (6 * (1 - t) * (x3 - 2 * x2 + x1) + 6 * t * (x4 - 2 * x3 + x2));
};
/**
 * Assuming x1 = 0, x4 = 1.
 */
...
export const cubic01Derivative = (x2, x3, t) => {
    const ti = 1 - t;
    return (3 * ti * ti * (x2) + 6 * ti * t * (x3 - x2) + 3 * t * t * (1 - x3));
};
/**
 * Assuming x1 = 0, x4 = 1.
 */
export const cubic01DerivativeSecond = (x2, x3, t) => {
    return (6 * (1 - t) * (x3 - 2 * x2) + 6 * t * (1 - 2 * x3 + x2));
};
/**
